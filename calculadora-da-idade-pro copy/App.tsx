...
import DateInputGroup from './calculadora-da-idade-pro copy/components/DateInputGroup';
import Auth from './calculadora-da-idade-pro copy/components/Auth';
import { supabase } from './calculadora-da-idade-pro copy/.vscode/lib/supabaseClient';
